...
function Parking() {
    ...
    const getAllData = () => {
        axios.get(`${url}api/location/getLocationByTypeWithOnePic/?type=parking`)
            .then((response) => {
    ...
    const showDeleteConfirm = (IdData) => {
        confirm({
            title: 'Are you sure delete this Parking Route?',
            ...
            onOk() {
                ...
                console.log('OK');
                Modal.success({
                    content: 'Parking Route Deleted Successfully',
                });
            },
            onCancel() {
                console.log('Cancel');
    ...
    const handleOkAdd = () => {
        ...
        axios(config)
            .then(function (response) {
                ...
                getAllData();
                Modal.success({
                    content: 'Added Parking Route Successfully',
                });
            })
    };
    const handleOkUpdate = () => {
        ...
        axios(config)
            .then(function (response) {
                ...
                Modal.success({
                    content: 'Updated Parking Route Successfully',
                });
                setImagesEdit([])
            })
    };
            ...
            <div style={marginTop}>
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} md={12}>
                        ...
                        >
                            <Item sx={{ flexGrow: 2 }}>
                                <Typography variant='h6' style={{ fontWeight: 700 }} >Parking Routes</Typography>
                            </Item>
                            <Item>
